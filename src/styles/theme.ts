...
export const gradients = {
  ...
  blackReverse: `linear-gradient(to top, ${colors.gray} 0, ${colors.gray} 85%, ${colors.black} 100%)`,
  darkBlue: `linear-gradient(to bottom, #74A4D6, ${colors.darkBlue})`,
  divider: `linear-gradient(to bottom, ${colors.black} 0, ${colors.black} 20%, ${colors.gray} 50%, ${colors.black} 80%, ${colors.black} 100%)`,
  ...
  multipass: `linear-gradient(to right, ${colors.lightBlue} 0, ${colors.lightBlue} 20%, ${colors.darkBlue} 50%, ${colors.purple} 80%, ${colors.purple} 100%)`,
  red: `linear-gradient(to bottom, ${colors.lightRed}, ${colors.red})`,
  sponsoredGreen: `linear-gradient(to bottom, ${colors.sponsoredLightGreen}, ${colors.sponsoredGreen})`,
};
