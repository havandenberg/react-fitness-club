export const intro =
  'In consideration of being allowed to participate in any way in React Fitness Club athletic sports program, related events and activities, the undersigned acknowledges, appreciates, and agrees that:';

export const clauseOne =
...
export const title = 'React Fitness Club Member Waiver/Release';
